...
export const TOOL_ROUTE_PROFILES = ['chat', 'automation'] as const satisfies readonly ToolRouteProfile[]
...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  {
    ...
    compatibilityNote: '这是 agent 交互工具，不适合严格 reply-agent 会话，容易把模型拉去做中间态交互。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是 agent 交互工具，和 submit_reply_plan 收口的聊天协议冲突。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是高风险写操作工具，不应出现在普通聊天链路里。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是文件代理能力的一部分，普通聊天里容易把模型带偏。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是高风险批量写操作，普通聊天链路不应暴露。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是最危险的写操作之一，普通聊天里不应开启。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是文件写回能力，适合后台代理，不适合普通聊天 persona。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibilityNote: '可以作为后台检索能力，但前提是最后仍通过 submit_reply_plan 收口，不要把搜索过程暴露给用户。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '会把模型拉进浏览器代理工作流，通常不适合普通聊天对话。',
    hardDependencies: [],
  ...
  },
  {
    ...
    compatibility: 'incompatible',
    compatibilityNote: '这是网页代理工具链的一部分，通常不应在普通聊天里直接开放。',
    hardDependencies: [],
