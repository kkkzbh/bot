...
export const BOT_CONSOLE_ENV_FIELDS: ManagedEnvField[] = [
  ...
  { key: 'MEMORY_V3_ENABLED', label: '长期记忆 v3', type: 'toggle', section: 'features' },
  { key: 'MEMORY_V3_READ_ENABLED', label: '长期记忆召回', type: 'toggle', section: 'features' },
  { key: 'MEMORY_V3_WRITE_ENABLED', label: '长期记忆写入', type: 'toggle', section: 'features' },
  { key: 'MEMORY_V3_EXTRACT_BASE_URL', label: '记忆提炼接口地址', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_API_KEY', label: '记忆提炼接口密钥', type: 'secret', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_MODEL', label: '记忆提炼模型', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_TIMEOUT_MS', label: '记忆提炼超时', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_REQUEST_MODE', label: '记忆提炼请求模式', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_STRUCTURED_OUTPUT_PROTOCOL', label: '记忆提炼输出协议', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_SUPPORTS_JSON_MODE', label: '记忆提炼 JSON mode', type: 'toggle', section: 'model' },
  { key: 'MEMORY_V3_EMBED_BASE_URL', label: '记忆向量接口地址', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EMBED_API_KEY', label: '记忆向量接口密钥', type: 'secret', section: 'model' },
  { key: 'MEMORY_V3_EMBED_MODEL', label: '记忆向量模型', type: 'text', section: 'model' },
  { key: 'MEMORY_V3_EMBED_TIMEOUT_MS', label: '记忆向量超时', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_QUERY_TOPK', label: '记忆召回 TopK', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_PROMPT_BUDGET_TOKENS', label: '记忆 prompt 预算', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_EMBED_BATCH_SIZE', label: '记忆向量批量', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_IDLE_MS', label: '记忆提炼静默窗口', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_EXTRACT_MESSAGE_BATCH', label: '记忆提炼消息数', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_ARCHIVE_DAYS', label: '记忆归档天数', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_MAX_JOB_RETRIES', label: '记忆任务重试', type: 'number', section: 'model' },
  { key: 'MEMORY_V3_JOB_LOCK_TIMEOUT_MS', label: '记忆任务锁超时', type: 'number', section: 'model' },
